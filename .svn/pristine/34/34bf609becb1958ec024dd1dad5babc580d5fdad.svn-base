...
function ReplayLayer:init() 
    ...
    self.last_btn = CCButton.put(self.play_ui, CCButton.createCCButtonByFrameName("czpdkreplay/lobby_gameplay_last_btn1.png", 
            "czpdkreplay/lobby_gameplay_last_btn2.png", "czpdkreplay/lobby_gameplay_last_btn1.png", function(tag, target)
    ...
    self.game_play = CCButton.put(self.play_ui, CCButton.createCCButtonByFrameName("czpdkreplay/lobby_gameplay_play_btn1.png", 
            "czpdkreplay/lobby_gameplay_play_btn2.png", "czpdkreplay/lobby_gameplay_play_btn1.png", function(tag, target)
    ...
    self.game_stop = CCButton.put(self.play_ui, CCButton.createCCButtonByFrameName("czpdkreplay/lobby_gameplay_stop_btn1.png", 
            "czpdkreplay/lobby_gameplay_stop_btn2.png", "czpdkreplay/lobby_gameplay_stop_btn1.png", function(tag, target)
    ...
    self.next_btn = CCButton.put(self.play_ui, CCButton.createCCButtonByFrameName("czpdkreplay/lobby_gameplay_nest_btn1.png", 
            "czpdkreplay/lobby_gameplay_nest_btn2.png", "czpdkreplay/lobby_gameplay_nest_btn1.png", function(tag, target)
                local layer = self:getParent()
                self.timer = 99
    ...
    CCButton.put(self.play_ui, CCButton.createCCButtonByFrameName("czpdkreplay/lobby_gameplay_return_btn1.png", 
            "czpdkreplay/lobby_gameplay_return_btn2.png", "czpdkreplay/lobby_gameplay_return_btn1.png", function(tag, target)
                self.isPlaying = false
