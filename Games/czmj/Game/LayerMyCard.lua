...
function LayerMyCard:addFlickerBtn(img, func)
    if TutorialLogic then
        TutorialLogic:check(self, 0)
    end
...
function LayerMyCard:updataHorizontalPos()
    if not self.card_uis then return end
