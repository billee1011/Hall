...
function SpriteNorthCard:initHorizontalPassed(index, ctype)
...
function SpriteNorthCard.addHorizontalPassed(item)
...
function SpriteNorthCard:initNorthVerticalPassed(index, ctype)
