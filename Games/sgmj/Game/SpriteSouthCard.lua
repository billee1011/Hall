...
function SpriteSouthCard:createHorizontalDirectArrow(dirct)
--[[	if dirct and dirct >= 1 and dirct <= 3 then --右边边玩家的碰牌
		--方向指示箭头 指示是碰谁的牌
		local rotation = {165,-95,-15}
		...
		self.directArrowSp:setPosition(ccp(- 5, self.base_size.height/2))
		
		local actionTo = CCSkewTo:create(1, 0, -10)
		--self.directArrowSp:runAction(actionTo)
	end]]
end
